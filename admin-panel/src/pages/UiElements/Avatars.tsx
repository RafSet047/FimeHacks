...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Cerebryx - React.js Admin Dashboard"
        description="This is React.js Avatars Dashboard page for Cerebryx - React.js Admin Dashboard"
      />
