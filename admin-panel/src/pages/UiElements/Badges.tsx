...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Cerebryx - React.js Admin Dashboard"
        description="This is React.js Badges Dashboard page for Cerebryx - React.js Admin Dashboard"
      />
